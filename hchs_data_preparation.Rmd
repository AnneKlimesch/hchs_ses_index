...
Important: Before going on with the code, manually assign an adequate value to the cases of the variable am_schube_ausb_001 with current value "10" (other/ non-specified) using the information provided in variable am_schube_ausb_002.
...
Important: Before going on with the code, manually assign an adequate value to the cases of the variable am_schube_ausb_003 with current value "12" (other educational degree) using the information provided in variable am_schube_ausb_004. 
